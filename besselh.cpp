/*  besselh.cpp
 *
 * C++ implementation of the function ZBESH.F
 * from the netlib AMOS library (A Portable Package for Bessel Functions
 * of a Complex Argument and Nonnegative Order)
 *
 * The function ZBESH.F and its dependencies has been translated
 * the f2c conversion utility (version 20060506).
 *
 */
...
static int c__15 = 15;
static int c__16 = 16;
static double c_b147 = .5;
static double c_b148 = 0.;
static int c__0 = 0;
...
double zabs2_(double *zr, double *zi)
{
    /* System generated locals */
    double ret_val=0.0;
...
/* ***BEGIN PROLOGUE  ZABS2 */
/* ***REFER TO  ZBESH,ZBESI,ZBESJ,ZBESK,ZBESY,ZAIRY,ZBIRY */

/*     ZABS2 COMPUTES THE ABSOLUTE VALUE OR MAGNITUDE OF A DOUBLE */
	...
	double *alim)
{
    ...
    extern /* Subroutine */ int zs1s2_(double *, double *, double
	    *, double *, double *, double *, int *,
	    double *, double *, int *);
    extern double zabs2_(double *, double *);
...
/* ***ROUTINES CALLED  ZASYI,ZBKNU,ZMLRI,ZSERI,ZS1S2,D1MACH,ZABS2 */
/* ***END PROLOGUE  ZACAI */
	...
	double *elim, double *alim)
{
    ...
    double bry[3], cyr[2], pti, spn, sti, zni, rzi, ptr, str, znr, rzr,
	    sc1i, sc1r, cscl, cscr, csrr[3], cssr[3], razn;
...
/* ***ROUTINES CALLED  ZBINU,ZBKNU,ZS1S2,D1MACH,ZABS2,ZMLT */
/* ***END PROLOGUE  ZACON */
	...
	*ierr)
{
    ...
    double s1i, az3, s2i, s1r, s2r, z3i, z3r, dig, fid, cyi[1], r1m5, fnu,
	     cyr[1], tol, sti, ptr, str, sfac, alim, elim, alaz, csqi, atrm,
	    ztai, csqr, ztar;
    extern /* Subroutine */ int zexp_(double *, double *, double *
	    , double *);
    extern double zabs2_(double *, double *);
    ...
    extern /* Subroutine */ int zacai_(double *, double *, double
	    *, int *, int *, int *, double *, double *,
	    ...
	    , zbknu_(double *, double *, double *, int *,
	    int *, double *, double *, int *, double *,
	    double *, double *);
    extern double d1mach_(int *);
    extern int i1mach_(int *);
    extern /* Subroutine */ int zsqrt_(double *, double *, double
	    *, double *);
	...
	alim)
{
    ...
    extern /* Subroutine */ int zdiv_(double *, double *, double *
	    , double *, double *, double *), zexp_(double *,
...
/*     ZASYI COMPUTES THE I BESSEL FUNCTION FOR float(Z).GE.0.0 BY */
...
/* ***ROUTINES CALLED  D1MACH,ZABS2,ZDIV,ZEXP,ZMLT,ZSQRT */
/* ***END PROLOGUE  ZASYI */
...
/* Subroutine */ int zbesh_(double *zr, double *zi, double *fnu,
	...
	cyi, int *nz, int *ierr)
{
    ...
    extern double zabs2_(double *, double *);
    double ascle, csgni;
    extern /* Subroutine */ int zacon_(double *, double *, double
	    *, int *, int *, int *, double *, double *,
	    int *, double *, double *, double *, double *,
	     double *);
    double csgnr;
    extern /* Subroutine */ int zbknu_(double *, double *, double
	    *, int *, int *, double *, double *, int *,
	    double *, double *, double *), zbunk_(double *,
	    double *, double *, int *, int *, int *,
	    double *, double *, int *, double *, double *,
	     double *);
    extern double d1mach_(int *);
    extern /* Subroutine */ int zuoik_(double *, double *, double
	    *, int *, int *, int *, double *, double *,
...
/* ***ROUTINES CALLED  ZACON,ZBKNU,ZBUNK,ZUOIK,ZABS2,I1MACH,D1MACH */
/* ***END PROLOGUE  ZBESH */
...
/* ***ROUTINES CALLED  ZABS2,ZASYI,ZBUNI,ZMLRI,ZSERI,ZUOIK,ZWRSK */
/* ***END PROLOGUE  ZBINU */
    /* Parameter adjustments */
    --cyi;
    --cyr;
	...
	nz, double *tol, double *elim, double *alim)
{
    ...
    double p1i, p2i, s1i, s2i, p2m, p1r, p2r, s1r, s2r, cbi, cbr,
	    caz, csi, fhs, fks, rak, czi, dnu, csr, elm, zdi, bry[3],
	    pti, czr, sti, zdr, cyr[2], rzi, ptr, cyi[2];
	  double ckr=0.0;
	  double cki=0.0;
    int inu;
    double str, rzr, cchi, cchr, alas, cshi;
    double dnu2=0.0;
    int inub, idum;
    double cshr, fmui, rcaz, csrr[3], cssr[3], fmur;
    extern /* Subroutine */ int zlog_(double *, double *, double *
	    , double *, int *);
    double smui;
    extern /* Subroutine */ int zdiv_(double *, double *, double *
	    , double *, double *, double *);
    double smur;
    extern /* Subroutine */ int zexp_(double *, double *, double *
	    , double *), zmlt_(double *, double *, double *,
	    double *, double *, double *);
    extern double zabs2_(double *, double *);
    int iflag, kflag;
    double coefi;
...
/* ***ROUTINES CALLED  DGAMLN,I1MACH,D1MACH,ZKSCL,ZSHCH,ZUCHK,ZABS2,ZDIV, */
	...
	double *elim, double *alim)
{
    ...
    double c1i, c1m, c1r, s1i, s2i, s1r, s2r, cyi[2], gnu, raz, cyr[2],
	    sti, bry[3], rzi, str, rzr, dfnu, fnui;
    extern double zabs2_(double *, double *);
...
/* ***ROUTINES CALLED  ZUNI1,ZUNI2,ZABS2,D1MACH */
/* ***END PROLOGUE  ZBUNI */
...
/* Subroutine */ int zexp_(double *ar, double *ai, double *br,
	double *bi)
{
    /* Builtin functions */
...
/* ***ROUTINES CALLED  ZUCHK,ZABS2,ZLOG */
/* ***END PROLOGUE  ZKSCL */
...
/* Subroutine */ int zlog_(double *ar, double *ai, double *br,
	double *bi, int *ierr)
{
    /* Initialized data */
...
/* ***ROUTINES CALLED  DGAMLN,D1MACH,ZABS2,ZEXP,ZLOG,ZMLT */
/* ***END PROLOGUE  ZMLRI */
	...
	double *ascle, double *alim, int *iuf)
{
    ...
    int idum;
    extern /* Subroutine */ int zlog_(double *, double *, double *
	    , double *, int *), zexp_(double *, double *,
	    double *, double *);
    extern double zabs2_(double *, double *);
...
/* ***ROUTINES CALLED  ZABS2,ZEXP,ZLOG */
/* ***END PROLOGUE  ZS1S2 */
	...
	nz, double *tol, double *elim, double *alim)
{
    ...
    double atol, fnup;
    extern /* Subroutine */ int zlog_(double *, double *, double *
	    , double *, int *), zdiv_(double *, double *,
	    double *, double *, double *, double *), zmlt_(
	    double *, double *, double *, double *,
	    double *, double *);
    extern double zabs2_(double *, double *);
    int iflag;
    double coefi, coefr, crscr;
    double ascle=0.0;
    extern /* Subroutine */ int zuchk_(double *, double *, int *,
	    double *, double *);
    extern double d1mach_(int *), dgamln_(double *, int *);
...
/*     ZSERI COMPUTES THE I BESSEL FUNCTION FOR float(Z).GE.0.0 BY */
...
/* ***ROUTINES CALLED  DGAMLN,D1MACH,ZUCHK,ZABS2,ZDIV,ZLOG,ZMLT */
/* ***END PROLOGUE  ZSERI */
...
/* Subroutine */ int zsqrt_(double *ar, double *ai, double *br,
	double *bi)
{
    /* Initialized data */
	...
	double *asumi, double *bsumr, double *bsumi)
{
    ...
    extern /* Subroutine */ int zlog_(double *, double *, double *
	    , double *, int *), zdiv_(double *, double *,
	    double *, double *, double *, double *);
    double zthi, test, tzar, zthr;
    extern double zabs2_(double *, double *);
    double rfnu2, zetai, ptfni, sumai, sumbi, zetar, ptfnr, razth, sumar,
	    sumbr, rzthi;
    extern double d1mach_(int *);
    double rzthr, rtzti;
    extern /* Subroutine */ int zsqrt_(double *, double *, double
...
/* ***ROUTINES CALLED  ZABS2,ZDIV,ZLOG,ZSQRT,D1MACH */
/* ***END PROLOGUE  ZUNHJ */
	...
	elim, double *alim)
{
    ...
    int nuf;
    double bry[3], cyr[2], sti, rzi, str, rzr, aphi, cscl, phii, crsc, phir;
    int init;
...
/* ***ROUTINES CALLED  ZUCHK,ZUNIK,ZUOIK,D1MACH,ZABS2 */
/* ***END PROLOGUE  ZUNI1 */
...
/* ***ROUTINES CALLED  ZAIRY,ZUCHK,ZUNHJ,ZUOIK,D1MACH,ZABS2 */
/* ***END PROLOGUE  ZUNI2 */
	...
	double *sumi, double *cwrkr, double *cwrki)
{
    ...
    /* Local variables */
    int i__, j, k, l;
    double ac, si, ti, sr, tr, t2i, t2r, rfn, sri, sti, zni, srr, str,
	    znr;
    int idum;
    extern /* Subroutine */ int zlog_(double *, double *, double *
	    , double *, int *), zdiv_(double *, double *,
...
/* ***ROUTINES CALLED  ZKSCL,ZS1S2,ZUCHK,ZUNIK,D1MACH,ZABS2 */
/* ***END PROLOGUE  ZUNK1 */
...
/* ***ROUTINES CALLED  ZAIRY,ZKSCL,ZS1S2,ZUCHK,ZUNHJ,D1MACH,ZABS2 */
/* ***END PROLOGUE  ZUNK2 */
...
/* ***ROUTINES CALLED  ZUCHK,ZUNHJ,ZUNIK,D1MACH,ZABS2,ZLOG */
/* ***END PROLOGUE  ZUOIK */
...
/* ***ROUTINES CALLED  D1MACH,ZBKNU,ZRATI,ZABS2 */
/* ***END PROLOGUE  ZWRSK */
