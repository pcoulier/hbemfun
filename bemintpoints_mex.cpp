 ...
 *
 *   X = BEMINTPOINTS(nod,elt,typ) returns the coordinates of the boundary
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
  try
  {
    ...
    for (unsigned int iElt=0; iElt<nElt; iElt++)
    {
      ...
      unsigned int nEltDivSing;
      eltdef(EltType,TypeID,TypeName,TypeKeyOpts,nKeyOpt,nEltType,EltParent,
             nEltNod,nEltColl,EltShapeN,EltShapeM,EltDim,AxiSym,Periodic,nGauss,
