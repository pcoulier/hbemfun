 ...
 * May 2009
 *
 * Parts of this file are taken from rmd128.c and rmd128.h.
 * See http://www.esat.kuleuven.be/~cosicart/ps/AB-9601.
 */
...
void rmdstring(const string& s, string& hash)
/*
 * returns RMD(message)
...
void rmdfile(const string& file, string& hash)
/*
 ...
 */
{
   ...
   /* initialize */
   hash.clear();
   if ((mf = fopen(file.c_str(), "rb")) == NULL) return;
